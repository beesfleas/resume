...
\begin{itemize}
	...
	\resitem{\textbf{Coursework:} GPU Micro architectures, Large Scale Data Mining, Convex Optimization, Dynamic Feedback Control, Deep Learning, Software Engineering, Embedded Systems, Computer Architecture,  Numerical Computing, Stochastic Systems,  Communications, Signals and Systems}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{itemize}
\resitem{\textbf{Programming Languages:} C, C++, Python (NUMBA, PySpark, Matplotlib, PyTorch, Pandas, Tensorflow), CUDA, PTX, Triton, System Verilog, SQL, x64, C\#, Java, MATLAB, R, JavaScript}
\resitem{\textbf{Tools:} Docker, Git, LangGraph, MongoDB, LTSpice, GDB, Unix Shell, OpenMP, Joblib, Django, NVIDIA Nsight Compute, Apache Spark, Fuzzing (AFL), CI/CD}
\end{itemize}
...
\begin{itemize}
    ...
    \resitem{Implemented and optimized foundation GPGPU kernels within the Vortex framework eg. MatMul}
\end{itemize}
...
\begin{itemize}
    ...
    \resitem{Scraped and analyzed public PySpark workflows from GitHub to create a representative distribution of modern data pipelines, guiding the synthesis of UDFs based on metrics like cyclomatic complexity.}
\end{itemize}
